...
output "web_linuxvm_private_ip_address_list" {
  ...
  value = [for vm in azurerm_linux_virtual_machine.web-linux-vm: vm.private_ip_address]
...
output "web_linuxvm_private_ip_address_map" {
  ...
  value = {for vm in azurerm_linux_virtual_machine.web-linux-vm: vm.name => vm.private_ip_address}
...
output "web_linuxvm_private_ip_address_keys_function" {
  description = "Web Linux Virtual Machine Private IP"
  value = keys({for vm in azurerm_linux_virtual_machine.web-linux-vm: vm.name => vm.private_ip_address})
}
...
output "web_linuxvm_private_ip_address_values_function" {
  description = "Web Linux Virtual Machine Private IP"
  value = values({for vm in azurerm_linux_virtual_machine.web-linux-vm: vm.name => vm.private_ip_address})
}
